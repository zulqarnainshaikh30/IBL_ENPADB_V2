...
CREATE FUNCTION [dbo].[AdvCustSecurityFun] (@TimeKey Int) 
RETURNS TABLE 
AS 
RETURN 
---------------*************************************************************************************

---------------*************** PLS ALSO CHANGE IN AdvCustSecurityFun IF ANY CHANGE IN THIS FUNCTION
...
SELECT  
 ...
 FROM (
                                  ...
                                  AND CBD.EffectiveFromTimeKey < = @Timekey
							                ...
							                AND  ADVSEC.ACCOUNTENTITYID IS NULL
          ...
          ----                                      ,ISNULL(CurrentValue,0) AS TotNFSecurity
