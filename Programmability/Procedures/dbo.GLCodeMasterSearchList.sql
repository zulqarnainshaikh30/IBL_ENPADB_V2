...
GO
CREATE PROC [dbo].[GLCodeMasterSearchList]
--Declare
...
--SELECT  GLAlt_Key,  GLCode,  GLName as GLDescription from DimGL_Mod order by 1 desc
			...
			IF(@OperationFlag not in (16,17,20))
			 ...
			 IF OBJECT_ID('TempDB..#temp') IS NOT NULL
                 ...
                 FROM
                 (
                     SELECT ROW_NUMBER() OVER(ORDER BY GLAlt_Key) AS RowNumber, 
   ...
   END TRY
	...
	select *,'GLCodeMaster' AS tableName from MetaScreenFieldDetail where ScreenName='GLCodeMaster'
