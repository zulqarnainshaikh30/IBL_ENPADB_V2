...
GO
CREATE PROCEDURE [dbo].[MetaDynamicScreenInserUpdateMain]
...
BEGIN
	...
	if(@MenuId =623 and @BaseColumnValue is NULL)
	BEGIN
	Set @OperationFlag = 1
	END
...
print 'Begin12'
	...
	--select * from ##TmpSrcTable
		...
		WHILE @RowId<=(SELECT COUNT(1) FROM ##TmpSrcTable)
			...
			--END
			--select * from FraudInvolvementDetail_Mod
