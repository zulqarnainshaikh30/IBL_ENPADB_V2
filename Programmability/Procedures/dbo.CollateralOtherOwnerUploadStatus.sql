...
GO
CREATE PROCEDURE [dbo].[CollateralOtherOwnerUploadStatus]
...
BEGIN
	...
	BEGIN
		...
		END
			ELSE
			BEGIN
			    Select '' SR_No,'' ColumnName,'Validating Excel Data' ErrorData,'' ErrorType,@FileName FileNames,'SUCCESS' Flag,'' Srnooferroneousrows,'Validation'TableName
