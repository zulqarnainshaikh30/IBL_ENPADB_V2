...
CREATE PROC [dbo].[ConstitutionMasterSearchList]
--Declare
...
/*  IT IS Used FOR GRID Search which are not Pending for Authorization And also used for Re-Edit    */
			...
			IF(@OperationFlag not in (16,17,20))
			 ...
			 IF OBJECT_ID('TempDB..#temp') IS NOT NULL
                 ...
                 GROUP BY   A.ConstitutionMappingAlt_key,
							A.SourceName,
							A.SourceAlt_Key,
							A.BankCode,
							A.BankDescription,
                 ...
                 FROM
                 (
                     SELECT ROW_NUMBER() OVER(ORDER BY ConstitutionMappingAlt_key) AS RowNumber, 
			 ...
			 IF OBJECT_ID('TempDB..#temp16') IS NOT NULL
				...
				-- Order By DataPointOwner.DateCreated Desc --Comment By Vinit
  ...
  SELECT *, 'DimConstitutionMaster' AS TableName FROM MetaScreenFieldDetail WHERE ScreenName='Constitution Master' and  MenuId=14554
