...
GO
CREATE PROC [dbo].[ACL_DATA_WITH_MOC]
AS

drop table if exists ACL_DATA_WITH_MOC_30092021 
...
----SELECT ActSegmentCode,* FROM PRO.ACCOUNTCAL
	...
	,CASE WHEN SecApp='S' THEN 'SECURED' ELSE 'UNSECURED' END AS SecuredUnsecured
	
into ACL_DATA_WITH_MOC_30092021
