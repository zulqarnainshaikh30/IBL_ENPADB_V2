...
-- =============================================
-- Author:		<Author,,Dipti>
-- Create date: <Create Date,,13072020
-- Description:	<Description,,get status while uploadingIBPC poll data>
-- =============================================
CREATE PROCEDURE [dbo].[GetStatusOfIBPCpoolUpload]
   ...
   --select 'abc'
	...
	--	--WHERE A.ROW=1
		...
		END
			ELSE
			BEGIN
			    Select '' SR_No,'' ColumnName,'Validating Excel Data' ErrorData,'' ErrorType,@FileName FileNames,'In Progress' Flag,'' Srnooferroneousrows
