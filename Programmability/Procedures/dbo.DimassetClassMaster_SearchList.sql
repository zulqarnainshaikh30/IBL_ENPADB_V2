...
GO
CREATE PROC [dbo].[DimassetClassMaster_SearchList]
...
/*  IT IS Used FOR GRID Search which are not Pending for Authorization And also used for Re-Edit    */
   ...
   END TRY
	...
	SELECT *, 'DimAssetMaster' AS TableName FROM MetaScreenFieldDetail WHERE ScreenName='Asset Class Master' and  MenuId=14568
