...
GO
CREATE PROCEDURE [dbo].[SP_RFDegradecountReport]
as
...
select convert(Date,DateofData,105)Date,A.[Host System],A.count as DegradeRFCount,B.count as DegradeReportCount
