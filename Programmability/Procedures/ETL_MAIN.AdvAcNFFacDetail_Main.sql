...
-- =============================================
CREATE PROCEDURE [ETL_MAIN].[AdvAcNFFacDetail_Main]
...
----Select * 
from IBL_ENPA_TEMPDB_V2.DBO.TempAdvNFACFacDetail A
Where Not Exists(Select 1 from DBO.AdvAcNFFacDETAIL B Where B.EffectiveToTimeKey=49999
...
FROM DBO.AdvAcNFFacDETAIL AS O
INNER JOIN IBL_ENPA_TEMPDB_V2.DBO.TempAdvNFACFacDetail AS T
...
----Select * 
from IBL_ENPA_TEMPDB_V2.DBO.TempAdvNFACFacDetail A
INNER JOIN DBO.AdvAcNFFacDETAIL B 
...
SET 
 ...
 ModifiedBy='SSISUSER' 
FROM DBO.AdvAcNFFacDETAIL AA
WHERE AA.EffectiveToTimeKey = 49999
AND NOT EXISTS (SELECT 1 FROM IBL_ENPA_TEMPDB_V2.DBO.TempAdvNFACFacDetail BB
...
SELECT @EntityKey=MAX(EntityKey) FROM  IBL_ENPA_DB_V2.[dbo].[AdvAcNFFacDetail] 
...
SELECT
	  ...
	  ,StockStmtDt
		   FROM IBL_ENPA_TEMPDB_V2.DBO.TempAdvNFACFacDetail T Where ISNULL(T.IsChanged,'U') IN ('N','C')
