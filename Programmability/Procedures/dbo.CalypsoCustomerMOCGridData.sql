...
CREATE PROCEDURE [dbo].[CalypsoCustomerMOCGridData]
	 @Timekey INT
...
BEGIN
   ...
   and UploadType =CASE WHEN @Menuid=24747 THEN'Calypso Customer MOC Upload'
						ELSE  NULL END 
   )   A
   ORDER BY DateofUpload  DESC,CASE WHEN AuthorisationStatus='NP' THEN CAST(1 AS VARCHAR(50))
                                ...
                                SELECT		UniqueUploadID ,UploadedBy,CONVERT(VARCHAR(10),DateofUpload,103) AS DateofUpload,
											AuthorisationStatus,UploadType,
