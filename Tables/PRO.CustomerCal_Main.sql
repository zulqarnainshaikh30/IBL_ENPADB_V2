CREATE TABLE [PRO].[CustomerCal_Main] (
  ...
  [MOCProcessed] [varchar](2) NULL,
  CONSTRAINT [Customercal_Main_CustomerEntityID] PRIMARY KEY NONCLUSTERED ([CustomerEntityID], [EffectiveFromTimeKey], [EffectiveToTimeKey]),
  CHECK ([EffectiveToTimeKey]=(49999))
)
ON [PRIMARY]
GO

CREATE CLUSTERED INDEX [CustomerCal_Main_ClsIdx]
  ON [PRO].[CustomerCal_Main] ([EntityKey])
  ON [PRIMARY]
GO