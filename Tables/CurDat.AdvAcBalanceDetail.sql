CREATE TABLE [CurDat].[AdvAcBalanceDetail] (
  ...
  [DPD_Bank] [int] NULL,
  CONSTRAINT [AdvAcBalanceDetail_Cur_AccountEntityID] PRIMARY KEY NONCLUSTERED ([AccountEntityId], [EffectiveFromTimeKey], [EffectiveToTimeKey]),
  CHECK ([EffectiveToTimeKey]=(49999))
)
ON [PRIMARY]
GO

CREATE CLUSTERED INDEX [AdvAcBalanceDetail_ClsIdx]
  ON [CurDat].[AdvAcBalanceDetail] ([EntityKey])
  ON [PRIMARY]
GO