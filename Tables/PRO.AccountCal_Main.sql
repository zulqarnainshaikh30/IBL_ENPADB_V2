CREATE TABLE [PRO].[AccountCal_Main] (
  ...
  CONSTRAINT [AccountCal_Main_AccountEntityID] PRIMARY KEY NONCLUSTERED ([AccountEntityID], [EffectiveFromTimeKey], [EffectiveToTimeKey]),
...
CREATE CLUSTERED INDEX [AccountCal_Main_ClsIdx]
  ON [PRO].[AccountCal_Main] ([EntityKey])
  ON [PRIMARY]
GO