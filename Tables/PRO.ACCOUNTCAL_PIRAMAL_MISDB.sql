CREATE TABLE [PRO].[ACCOUNTCAL_PIRAMAL_MISDB] (
  ...
  [PNPA_Reason] [text] NULL,
  [SMA_Class] [varchar](5) NULL,
  [SMA_Reason] [text] NULL,
  [FlgMoc] [char](1) NULL,
  [MOC_Dt] [date] NULL,
  ...
  [STDProvCat] [int] NULL,
  [InsuranceAmt] [decimal](16, 2) NULL,
  [InsuProvsecured] [decimal](16, 2) NULL,
  [InsuProvUnsecured] [decimal](16, 2) NULL,
