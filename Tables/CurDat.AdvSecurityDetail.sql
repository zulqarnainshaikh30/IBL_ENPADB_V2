CREATE TABLE [CurDat].[AdvSecurityDetail] (
  ...
  CONSTRAINT [AdvSecurityDetail_SecurityEntityID] PRIMARY KEY NONCLUSTERED ([SecurityEntityID], [EffectiveFromTimeKey], [EffectiveToTimeKey]),
